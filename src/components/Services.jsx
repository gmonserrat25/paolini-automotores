      ...
      <div className="mx-auto max-w-[1440px]">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,420px)_1fr] lg:gap-20">
          <div>
            ...
            <h2 className="mt-3 font-bebas text-[44px] leading-none text-white sm:text-[56px] lg:text-[64px]">
              Comprar tu auto, simple de verdad
            </h2>
            <p className="mt-6 max-w-[414px] font-inter text-[17px] leading-[27px] text-[#9A9CA8]">
          ...
          <div className="grid gap-px overflow-hidden rounded-2xl bg-white/10 sm:grid-cols-2">
            {SERVICES.map((s) => (
              <div key={s.n} className="bg-[#08080A] p-8">
                <span className="font-bebas text-[22px] text-[#E0323F]">
                  {s.n}
                </span>
                <h3 className="mt-3 font-inter text-[19px] font-semibold text-white">
                  {s.title}
                </h3>
                <p className="mt-2 font-inter text-[15px] leading-[24px] text-[#9A9CA8]">
                  {s.body}
                </p>
              </div>
            ))}
